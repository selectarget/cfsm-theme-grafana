...
export const messages = {
  zh: {
    ...
    totalTraffic: '月度累计流量',
    combinedFlow: '进出总和',
    todayTraffic: '今日消耗总流量',
    todayRx: '今日下载',
    todayTx: '今日上传',
    dailyTrafficTrend: '每日消耗流量趋势 (最近 7 天)',
  ...
  en: {
    ...
    todayTraffic: "Today's Total Traffic",
    todayRx: 'Today Download',
    todayTx: 'Today Upload',
    dailyTrafficTrend: 'Daily Traffic Consumption (Last 7 Days)',
